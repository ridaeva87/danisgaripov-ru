      ...
      {isContactStep ? (
        <div className="space-y-5">
          ...
          <p className="rounded-md border border-border/60 bg-surface-soft/60 p-3 text-xs leading-5 text-muted-foreground">
            Мини-разбор на картах таро — символический формат и не является финансовой, юридической или инвестиционной рекомендацией. Практические финансовые решения Данис оказывает как финансовый брокер отдельно.
          </p>
